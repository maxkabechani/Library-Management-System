...
exports.up = async (pgm) => {
    ...
    books.forEach((book) => {
        pgm.sql(`
            INSERT INTO book (title, author, isbn, published_year, genre, description, available_copies, total_copies, location)
            VALUES ('${book.title}', '${book.author}', '${book.isbn}', '${book.published_year}', '${book.genre}', '${book.description}', ${book.available_copies}, ${book.total_copies}, '${book.location}');
        `);
    });
};
